const litanyLines = [
  ...
  "",
  "Predmolitelj: Postavio ga je gospodarom doma svojega.",
  "Narod: I poglavarom svega imanja svojega.",
  "",
  "Pomolimo se:",
...
export const svetiJosipNovena = {
  slug: "sveti-josip",
  title: "Devetnica svetom Josipu",
  shortTitle: "Sv. Josip",
  ...
  theme:
    "Na kalendaru se posebno ističe u ožujku jer vodi prema svetkovini sv. Josipa 19. ožujka.",
  intro:
    "Na ovoj stranici je raspisan puni tekst devetnice svetom Josipu. Klik iz kalendara vodi izravno na ovu molitvu kako bi bilo jasno što se moli toga dana.",
  pageTitle: "Kako moliti devetnicu svetom Josipu",
  pageDescription:
    "Pripravna molitva, devet dana devetnice, litanije sv. Josipa i završne molitve.",
  link: "../devetnice/sveti-josip.html",
  homeLink: "devetnice/sveti-josip.html",
  details: [
    "Počinje 10. ožujka i traje do uoči svetkovine 19. ožujka.",
    "Klik na oznaku u kalendaru vodi izravno na ovu stranicu.",
    "Svaki dan uključuje glavnu molitvu, zazive i litanije sv. Josipa."
  ],
  preparation: [
    "Sveti Josipe, poočime našega Gospodina Isusa Krista! Ja, siromašni grješnik, položio sam veliko povjerenje u tvoj moćan zagovor i znam da ti neće biti uskraćena od Isusa nijedna molba. Budući da sada imam posebnu potrebu, odlučio sam se da te tijekom devet dana ustrajno zazivam, da po tvom zagovoru nađem uslišanje kod Boga. Na Njegovu veću slavu i za spas svoje duše, započinjem sada devetodnevnu molitvu."
  ],
  days: [
    {
      day: 1,
    ...
    },
    {
      ...
      title: "Treći dan",
      paragraphs: [
        "Pozdravljam te, sveti Josipe! Štujem te iz svega srca. Tebe je Marija, Majka Božja, nazvala poočimom svoga božanskog Sina i ljubila kao svog djevičanskog supruga. Spomeni se velike milosti što si tako povjerljivo mogao živjeti zajedno s Isusom i Marijom.",
        "Kako si rado ispunjavao svoje dužnosti, kakvom li je nebeskom utjehom bilo preplavljeno tvoje srce. Sigurno ti je bila draža skromna kuća s njezinom radionicom u blizini Isusa i Marije nego veličanstvena palača na zemlji. Kako si brižno pohitao u nepoznato i pobjegao u Egipat da svoju obitelj zaštitiš pred Herodom. Kako je bila velika tvoja strpljivost u žalosti, strahu i nevolji!",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Sveti Josipe, u pomisli na neizrecivu ljubav i radost koje si osjetio u krugu Isusa i Marije, i na sve žalosti koje si nosio u zajedništvu sa svojom svetom obitelji, molim milost da se ni u žalostima ni u radostima ne odijelim od Božje ljubavi, koja je prisutna u Kristu, našem Gospodinu. Amen."
      ],
      prayers: [
        "Oče naš...",
        "Zdravo Marijo...",
    ...
    },
    {
      ...
      title: "Deveti dan",
      paragraphs: [
        "Dragi sveti Josipe, tebi sam se utekao, u tebe se pouzdao. Uvjeren sam da ćeš Bogu preporučiti moju želju. Po tvojoj ljubavi, koja te je u radosti i žalosti vezala s Isusom i Marijom, utječem se tebi za zagovor.",
  ...
  closingSections: [
    ...
    {
      title: "Čudotvorna molitva svetom Josipu",
      paragraphs: [
        ...
        "O, sveti Josipe, pomozi mi svojim snažnim zagovorom i izmoli za mene svog djevičanskog Sina sve duhovne blagoslove kroz Isusa Krista, našega Gospodina, tako da, jer sam vezan o tvojoj nebeskoj snazi, mogu iskazati svoju zahvalu i poštovanje najljubljenijem Ocu.",
